...
variable "service_name" {
  description = "Nome do microserviço a ser deployado (ex: auth-service, customer-service, etc)"
  type        = string
  # Exemplos: eureka-server, auth-service, customer-service, catalog-service, 
  # inventory-service, budget-service, work-order-service, notification-service
}